    ...
    return (<>
        <div className="container">
            ...
            <div className="row">
                ...
                <img className='col-12 col-lg-6 col-md-12' src='girl.svg' alt='girl' />
                <div className='col-12 col-lg-6 col-md-12 d-flex align-items-center'>
                    ...
                    <div>
                        ...
                        <div className="d-flex justify-content-around mb-4">
                            <div className="form-check">
                                <input onClick={() => setShowId(!showId)} className="form-check-input" type="checkbox" value={showId} id="flexCheckDefault" />
